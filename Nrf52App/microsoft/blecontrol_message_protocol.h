...
/// <summary>
///     Signature for a function to process commands from azure as aggregator.
/// </summary>
/// <returns>0 if deleting all BLE bonds successfully, other values if an error occurred.</returns>
typedef int (*message_protocol_azure_app_cmd_handler)(uint8_t *p_data, uint16_t data_size);
/// <summary>
///     Signature for a function to process commands from azure as aggregator.
/// </summary>
/// <returns>0 if deleting all BLE bonds successfully, other values if an error occurred.</returns>
typedef int (*message_protocol_get_aggr_data_handler)(uint8_t *p_data, uint16_t data_size);
...
void ble_control_message_protocol_init(
    ...
    message_protocol_get_aggr_data_handler m_get_aggregator_data_handler);
