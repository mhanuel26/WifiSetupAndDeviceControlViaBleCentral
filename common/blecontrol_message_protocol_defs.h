...
static const MessageProtocol_RequestId BleControlMessageProtocol_ProcessAzureCmdsRequestId =
    0x0005;
/// <summary>
///     Request ID for Getting Aggregator Data back to Azure.
/// </summary>
static const MessageProtocol_RequestId BleControlMessageProtocol_ReturnAggregatorCmdRequestId =
    0x0006;
...
///// <summary>
/////     Event ID for a message indicating the device as Central has some event.
///// </summary>
static const MessageProtocol_EventId BleControlMessageProtocol_Lbs_C_Button_EventId = 0x0005;

///// <summary>
/////     Event ID for a message indicating the device as Central has some event.
///// </summary>
static const MessageProtocol_EventId BleControlMessageProtocol_Ble_Client_EventId = 0x0006;
